...
* [Android]()
	...
	* [单聊](#{site.base_url}/docs/emchat/android/singlechat.html)
		...
		* [好友列表管理：获取好友列表。好友列表更改事件回调](#{site.base_url}/docs/emchat/android/contactmanager.html)
		* [好友列表管理：查找好友（根据账号），添加好友，删除好友，黑名单](#{site.base_url}/docs/emchat/android/contactmanager.html)
